              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Textwidget(
                          text: controller.addresss.value,
                          fontSize: 18,
                          maxLines: 5,
                        ),
                      ),
                ...
                controller.isLoading.isTrue
                    ? SizedBox(
                        ...
                        child: Center(
                          child: ShowLoader.isLoadingProgress(
                        ...
                        : Expanded(
                            child: ListView.builder(
                                ...
                                itemBuilder: (buildContext, index) {
                                  var list =
                                      controller.cleanercohostList[index];
                                      ...
                                      onTap: () {
                                        var data = {
                                          ...
                                          "cleaner_cohost_id":
                                              list.id.toString(),
                                          "user_type":
                                              controller.userType.toString(),
                                          "service_id":
                                              controller.serviceId.toString(),
                                          "service_name":
                                              controller.serviceName.toString(),
                                          "address": controller.addresss.value
                                              .toString(),
                                        };
                                        Get.toNamed(Routes.MAID_DETAILS,
                                            parameters: data, arguments: true);
                                      },
                                      child: Card(
                                                              ...
                                                              children: [
                                                                ...
                                                                Flexible(
                                                                  child:
                                                                      Textwidget(
                                                                    text:
                                                                        "${list.rating} ( ${list.review} Review )",
                                                                    fontSize:
                                                                        12,
                                                                    fontWeight:
                                                                        FontWeight
