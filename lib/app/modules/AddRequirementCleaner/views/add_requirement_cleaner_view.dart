...
class AddRequirementCleanerView
                                    ...
                                    items: controller.propertyList.map((item) {
                                      return DropdownMenuItem<String>(
                                        onTap: () {
                                          ...
                                          controller.propertySizeSQFT.value = "${controller.propertySizeSQFT_pro.value}";
                                          var splittext = controller.propertySizeSQFT.value!.split(' ');
                                          var size = splittext[1];
                                          controller.propertySizeSqrFeet.value = size.toString();
                  ...
                  if(controller.serviceId.value == "1" || controller.serviceId.value == "2" || controller.serviceId.value == "4")
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Textwidget(
                                          text: controller.serviceTypeList[index],
                                          fontSize: 15,
                                        ),
                                      ],
                                    ),
                                              ...
                                              onPressed: (){
                                                ...
                                                if (index == 0) {
                                                  ...
                                                  if (controller.perHourQty.value > 0) {
                                                    ...
                                                    updateServiceListDecrement(index, lable, controller.perHourQty.value, total,lable.deepPrice);
                                                  }
                                                }
                    ...
                    controller.isLoading.isTrue
                      ...
                      children: [
                        ...
                        Obx(() =>  SizedBox(
                          height: 30,
                          child: ListView.builder(
                              itemCount: controller.serviceTypeListPerHour.length,
                              scrollDirection: Axis.horizontal,
                              shrinkWrap: true,
                              itemBuilder: (buildContext, index) {
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    splashColor: Colors.transparent,
                                    onTap: () {
                                      controller.selectServiceWeeklySqrFeel.value = index.toString();
                                      // controller.property_size_sqrFeet.value = '';
                                    },
                                    child: Row(
                                      children: [
                                        Obx(() => controller.selectServiceWeeklySqrFeel.value == index.toString()
                                            ? Image.asset(
                                          "assets/icons/graycirculefill.png",
                                          height: 25,
                                        )
                                        ...
                                        Textwidget(
                                          text: controller.serviceTypeListPerHour[index],
                                          fontSize: 15,
                                        ),
                                      ],
                                    ),
                        ...
                        // prices
                        if(controller.selectServiceWeeklySqrFeel.value == "0")
                          Obx(() => ListView.builder(
                              ...
                              itemBuilder: (buildContext, index){
                                ...
                                if(controller.weeklyList[index].squareFeet == controller.propertySizeSqrFeet.value){
                                  controller.sQft.value = controller.weeklyList[index].squareFeet;
                                  controller.totalSqftPrice.value = controller.weeklyList[index].servicePrice;
                                }else{}
                                return Padding(
                                  padding: const EdgeInsets.only(
                                      left: 10, right: 10, top: 5),
                                  child: controller.weeklyList[index].squareFeet == controller.propertySizeSqrFeet.value
                                      ?Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Image.asset(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Textwidget(
                                            text: "${controller.sQft.value} Sq.ft" ,
                                            fontWeight: FontWeight.w600,
                                            fontSize: 16,
                                          ),
                                          Textwidget(
                                            text: "\$${controller.totalSqftPrice} - ${
                                                controller.selectServiceWeeklySqrFeel.value == "0"
                                                ?"Week"
                                                :controller.selectServiceWeeklySqrFeel.value == "1"
                                                ?"Bi Week"
                                                    :"Month"
                                            }",
                                            color: AppStyles.appThemeColor,
                        ...
                        else if(controller.selectServiceWeeklySqrFeel.value == "1")
                          Obx(() => ListView.builder(
                              ...
                              itemBuilder: (buildContext, index){
                                ...
                                if(controller.biWeeklyList[index].squareFeet == controller.propertySizeSqrFeet.value){
                                  controller.sQft.value = controller.biWeeklyList[index].squareFeet;
                                  controller.totalSqftPrice.value = controller.biWeeklyList[index].servicePrice;
                                }else{}

                                return Padding(
                                  padding: const EdgeInsets.only(
                                      left: 10, right: 10, top: 5),
                                  child: controller.biWeeklyList[index].squareFeet == controller.propertySizeSqrFeet.value
                                      ?Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Image.asset(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Textwidget(
                                            text: "\$${controller.totalSqftPrice.value} - ${
                                                controller.selectServiceWeeklySqrFeel.value == "0"
                                                    ?"Week"
                                                    :controller.selectServiceWeeklySqrFeel.value == "1"
                                                    ?"Bi Week"
                         ...
                         Obx(() => ListView.builder(
                             ...
                             itemBuilder: (buildContext, index){
                               ...
                               if(controller.monthlyList[index].squareFeet == controller.propertySizeSqrFeet.value){
                                 controller.sQft.value = controller.monthlyList[index].squareFeet;
                                 controller.totalSqftPrice.value = controller.monthlyList[index].servicePrice;
                               }else{}
                               return Padding(
                                 padding: const EdgeInsets.only(
                                     left: 10, right: 10, top: 5),
                                 child: controller.monthlyList[index].squareFeet == controller.propertySizeSqrFeet.value
                                     ?Row(
                                   crossAxisAlignment: CrossAxisAlignment.start,
                                   children: [
                                     Image.asset(
                    ...
                    controller.isLoading.isTrue
                      ...
                      children: [
                              ...
                              itemBuilder: (buildContext, index) {
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    splashColor: Colors.transparent,
                                    onTap: () {
                                      controller.selectServiceWeeklyHourly.value = index.toString();
                                      controller.hourQty.value = "0";
                                      controller.hourQtyController.clear();
                        ...
                        if(controller.selectServiceWeeklyHourly.value == "0")
                              ...
                              child: Row(
                                ...
                                children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Textwidget(
                                                text: "\$${controller.weeklyListH[i].servicePrice}",
                                                fontSize: 12,
                                                color: AppStyles.appThemeColor,
                                                fontWeight: FontWeight.w700,
                                              ),
                                              ...
                                              Textwidget(
                                                textscalefector: 1,
                                                text: controller.hourQty.isEmpty?"0":controller.hourQty.value,
                                                fontWeight: FontWeight.w700,
                                                color: AppStyles.appThemeColor,
                                                fontSize: 12,
                                              )
                                  ...
                                  SizedBox(
                                    width: 100,
                                    child: TextFormField(
                                      controller: controller.hourQtyController,
                                      ...
                                      onFieldSubmitted: (value) {
                                        ...
                                        if(int.parse(value) >= 2){
                                          controller.hourQty.value = controller.hourQtyController.text.toString();
                                          int total = int.parse(controller.weeklyListH[i].servicePrice)*int.parse(controller.hourQty.value);
                                          controller.totalHourlyPrice.value = total.toString();
                                          controller.actualHourlyPrice.value = controller.weeklyListH[i].servicePrice;
                                          ...
                                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                            ...
                                            content: Center(child: Textwidget(text: "Minimum 2 hour services",color: Colors.white,)),
                                          ));
                                        }
                        ...
                        else if(controller.selectServiceWeeklyHourly.value == "1")
                          for(int i=0;i<controller.biWeeklyListH.length;i++)
                            Obx(() => Padding(
                              padding: const EdgeInsets.only(
                                  left: 10, right: 10, top: 5),
                              child: Row(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Textwidget(
                                                text: "\$${controller.biWeeklyListH[i].servicePrice}",
                                                fontSize: 12,
                                                color: AppStyles.appThemeColor,
                                                fontWeight: FontWeight.w700,
                                              ),
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onFieldSubmitted: (value) {
                                        if(int.parse(value) >= 2){
                                          controller.hourQty.value = controller.hourQtyController.text.toString();
                                          int total = int.parse(controller.biWeeklyListH[i].servicePrice)*int.parse(controller.hourQty.value);
                                          controller.totalHourlyPrice.value = total.toString();
                                          controller.actualHourlyPrice.value = controller.biWeeklyListH[i].servicePrice;
                          ...
                          for(int i=0;i<controller.monthlyListH.length;i++)
                            Obx(() => Padding(
                           padding: const EdgeInsets.only(
                               left: 10, right: 10, top: 5),
                           child: Row(
                                   ...
                                   Column(
                                     ...
                                     children: [
                                       ...
                                       Row(
                                         children: [
                                           Textwidget(
                                             text: "\$${controller.monthlyListH[i].servicePrice}",
                                             fontSize: 12,
                                             color: AppStyles.appThemeColor,
                                             fontWeight: FontWeight.w700,
                                           ),
                               ...
                               SizedBox(
                                 ...
                                 child: TextFormField(
                                   ...
                                   onFieldSubmitted: (value) {
                                     if(int.parse(value) >= 2){
                                       controller.hourQty.value = controller.hourQtyController.text.toString();
                                       int total = int.parse(controller.monthlyListH[i].servicePrice)*int.parse(controller.hourQty.value);
                                       controller.totalHourlyPrice.value = total.toString();
                                       controller.actualHourlyPrice.value = controller.monthlyListH[i].servicePrice;
                  ...
                  Row(
                    ...
                    children: [
                      Flexible(
                          child: Textwidget(
                        maxLines: 10,
                        text: "Cleaner needs to wash and dry linen and towels",
                        fontSize: 12,
                      )),
                      Padding(
  ...
  void updateServiceListIncrement(int index, lable, int newQty, int total,String actualPrice) {
// Check if the item already exists in the list
  ...
  void updateServiceListDecrement(int index, lable, int newQty, int total,String actualPrice) {
    if (newQty == 0) {
      // Clear lists if quantity is 0
      controller.serviceLableId.clear();
      controller.serviceTitleList.clear();
      ...
      if (controller.serviceQtyList.isEmpty || controller.serviceQtyList.length <= index) {
